...
func (cd *CourseDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, CourseMutation](ctx, cd.sqlExec, cd.mutation, cd.hooks)
}
...
func (cd *CourseDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(course.Table, sqlgraph.NewFieldSpec(course.FieldID, field.TypeUint64))
