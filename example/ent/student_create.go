...
func (sc *StudentCreate) SetAge(i int8) *StudentCreate {
	sc.mutation.SetAge(i)
	return sc
}

// SetBirthAt sets the "birth_at" field.
func (sc *StudentCreate) SetBirthAt(t time.Time) *StudentCreate {
	sc.mutation.SetBirthAt(t)
	return sc
}
...
func (sc *StudentCreate) AddCourseIDs(ids ...uint64) *StudentCreate {
...
func (sc *StudentCreate) AddExamIDs(ids ...uint64) *StudentCreate {
	sc.mutation.AddExamIDs(ids...)
	return sc
}

// AddExams adds the "exams" edges to the Exam entity.
func (sc *StudentCreate) AddExams(e ...*Exam) *StudentCreate {
...
func (sc *StudentCreate) check() error {
	...
	if _, ok := sc.mutation.BirthAt(); !ok {
		return &ValidationError{Name: "birth_at", err: errors.New(`ent: missing required field "Student.birth_at"`)}
	}
	return nil
}
...
func (sc *StudentCreate) createSpec() (*Student, *sqlgraph.CreateSpec) {
	...
	if value, ok := sc.mutation.BirthAt(); ok {
